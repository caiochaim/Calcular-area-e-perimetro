...
{
    public class Paralelogramo : Forma, ICalculator
    {
        public double Area()
        {
            // faz uma condicional para saber se tem todos os lados iguais, se tiver ele retorna a área e perímetro de um quadrado, 
            // pois todo quadrado também é um paralelogramo. O mesmo acontece com o perímetro.
        ...
        {
            return string.Format("A área e perímetro do paralelogramo são respectivamente {0} e {1}", AreaForma, PerimetroForma);
        }
    }
}
